...
const EditCarForm = (props) => {
    ...
    const [fabricationDate, setFabricationDate] = React.useState(props.content.fabricationDate)
    const [insuranceDate, setInsuranceDate] = React.useState(props.content.insuranceValability)
    const [itpDate, setItpDate] = React.useState(props.content.itpValability)
    const [nextServiceDate, setNextServiceDate] = React.useState(props.content.nextService)
    ...
    const submitAddCar = () => {
        ...
        console.log('req', req);
        axios.put( `http://localhost:8000/cars/${props.content.id}`, req).then(function(response){
            ...
            <Grid container direction="column" justify="center" alignItems="center">
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.manufacturer}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.model}
                        className={classes.textField}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        className={classes.textField}
                        defaultValue={props.content.color}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.engine}
                        className={classes.textField}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.licencePlate}
                        className={classes.textField}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.vin}
                        className={classes.textField}
                ...
                <div className={classes.wrapper}>
                    ...
                    <TextField
                        ...
                        defaultValue={props.content.image}
                        className={classes.textField}
